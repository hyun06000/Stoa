"""stoa-cli command-line interface.
...
from .core import keygen, resolve_identity


def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="stoa-cli", description="Stoa identity tools")
    p.add_argument("--version", action="version", version=f"stoa-cli {__version__}")
