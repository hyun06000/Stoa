...
- 2026-05-01 — **기술 스택 결정**: 모든 코드는 AIL로 작성·테스트·디버그한다 (CLAUDE.md 규칙 10). 사용자 명시 지시. AIL 문법 reference card: https://github.com/hyun06000/AIL/blob/main/docs/reference_card.ai.md.
